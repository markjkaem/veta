        ...
        <div className="  h-screen flex flex-col items-center justify-center px-6 py-8 lg:py-0">
          <div className=" rounded-lg shadow  sm:max-w-md md:mt-0 xl:p-0">
            <div className="flex flex-col items-center justify-center space-y-4 p-6 sm:p-8 md:space-y-6">
              ...
              <div className="grid-grid-cols-1 grid  gap-2 md:grid-cols-2 md:gap-4">
                <button
                ...
                />
                <button className="focus:ring-[#7289da]/55 mr-2 inline-flex h-10 w-48 items-center rounded-lg bg-[#7289da] px-5 py-2.5 text-center text-xs font-medium text-white hover:bg-[#7289da]/90 focus:outline-none focus:ring-4 focus:ring-[#7289da]/50">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <input
                  ...
                  value="/dashboard/overview"
                />
                <button className="focus:ring-[#7289da]/55 mb-2 mr-2 inline-flex h-10 w-48 items-center rounded-lg bg-black px-5 py-2.5 text-center text-xs font-medium text-white hover:bg-black focus:outline-none focus:ring-4 focus:ring-black">
                  <svg
                    className="mr-2 h-4 w-4"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 496 512"
